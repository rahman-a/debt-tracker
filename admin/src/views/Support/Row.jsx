...
import { Lock, Check, Copy, LockOpen } from '@/src/icons'
...
const Row = ({ ticket, idx }) => {
  ...
  const supportInfoClasses = classnames(style.support__info, {
    [style.support__info_ar]: i18next.language === 'ar',
  })
  ...
  return (
    <>
      ...
      <tr>
        ...
        <td className={supportInfoClasses}>
          <figure>
