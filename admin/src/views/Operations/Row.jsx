      ...
      <tr>
        ...
        <td style={{ padding: '0' }}>
          <div className={style.operations__party}>
            <span
              className={style.operations__label}
              style={{
                backgroundColor:
                  operation.initiator.type === 'debt' ? '#198754' : '#1a374d',
              }}
            >
            ...
            <span>
              <Badge bg='dark'>{operation.initiator.user.code}</Badge>
              <CopyToClipboard
                text={operation.initiator.user.code}
                onCopy={() => copyCodeHandler(operation.initiator.user.code)}
              >
                <span
                  className={`${style.operations__code} ${
                    lang === 'ar' ? style.operations__code_ar : ''
                  }`}
                >
        ...
        <td style={{ padding: '0' }} className={style.operations__party}>
          <div className={style.operations__party}>
            <span
              ...
              style={{
                backgroundColor:
                  operation.peer.type === 'debt' ? '#198754' : '#1a374d',
              }}
            >
            ...
            <span>
              <Badge bg='dark'>{operation.peer.user.code}</Badge>
              <CopyToClipboard
                text={operation.peer.user.code}
                onCopy={() => copyCodeHandler(operation.peer.user.code)}
              >
                <span
                  className={`${style.operations__code} ${
                    lang === 'ar' ? style.operations__code_ar : ''
                ...
                >
                  {copyCode === operation.peer.user.code ? <Check /> : <Copy />}
                </span>
              </CopyToClipboard>
            </span>
          </div>
