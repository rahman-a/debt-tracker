...
const BrokenHeart = (props) => {
  return (
    <svg version="1.1" id="Layer_1" width="1em" height="1em" {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <g>
        <g>
            <g>
                <path fill="currentColor" d="M375.026,46.268c-31.688,0-62.593,12.083-87.023,34.024c-1.109,0.995-1.989,2.215-2.588,3.579
                ...
                <path fill="currentColor" d="M225.345,401.113c-2.32-3.504-2.32-8.032,0-11.536l34.158-51.599c2.314-3.497,2.314-8.038-0.001-11.536l-34.157-51.591
