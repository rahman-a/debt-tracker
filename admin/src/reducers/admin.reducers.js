...
const memberUpdate = (state, action) => {
  const cases = {
    [constants.admin.MEMBERS_UPDATE_REQUEST]: {
      loading: true,
      error: null,
    },
    [constants.admin.MEMBERS_UPDATE_SUCCESS]: {
      loading: false,
      error: null,
      message: action.payload,
    },
    [constants.admin.MEMBERS_UPDATE_FAIL]: {
      loading: false,
      error: action.payload,
    },
    [constants.admin.MEMBERS_UPDATE_RESET]: {
      loading: false,
      error: null,
      message: null,
    },
