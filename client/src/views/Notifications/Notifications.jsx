...
import { Spinner, CheckDouble, Times, Redo } from '@/src/icons'
...
const Notifications = () => {
  ...
  const { loading, error, count, notifications } = useSelector(
    (state) => state.listNotifications
  )
                ...
                <Notification
                  ...
                  data={{
                    ...
                    state: notification.operation?.state
                      ...
                      : null,
                    report: notification?.report ? notification.report : null,
