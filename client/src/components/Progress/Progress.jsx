...
const ProgressBar = ({ step }) => {
  ...
  return (
    <div
      className={`${style.progress} ${lang === 'ar' ? style.progress_ar : ''}`}
    >
      <div
