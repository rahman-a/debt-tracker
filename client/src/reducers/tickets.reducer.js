...
const createTicket = (state, action) => {
    const cases = {
        [constants.tickets.CREATE_TICKET_REQUEST]: 
        {
            loading:true,
            error:null
        },
        [constants.tickets.CREATE_TICKET_SUCCESS]: 
        {
            loading:false,
            error:null,
            message:action.payload
        },
        [constants.tickets.CREATE_TICKET_FAILS]: 
        {
            loading:false,
            error:action.payload
        },
        [constants.tickets.CREATE_TICKET_RESET]: 
        {
            loading:false,
            error:null,
            message:null
