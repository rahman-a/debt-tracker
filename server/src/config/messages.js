export const messages = {
    payLate(report){
       return {
        en:`Dua Date Passed, Please Complete Your Payment for payment operation number ${report}, 
    ...
    doneLatePayment(report){
       return {
            en:`Confirmation of payment process number #{{${report}}}, your account badge has turned into green`,
            ar:`تاكيد عملية الدفع رقم #{{${report}}}, شارة الحساب تحولت الى اللون الاخضر`
        }
    },
    ...
    idExpired:{
        en:`Identity has expired, please upload new identity with a new expiry date`,
        ar:`لقد انتهت تاريخ صلاحية بطاقة الهوية من فضل ارفع بطاقة الهوية الجديدة بتاريخ صلاجية جديد`
    },
    passExpired:{
        en:`Passport has expired, please upload new Passport with a new expiry date`,
